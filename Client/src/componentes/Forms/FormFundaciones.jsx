        ...
        <Form className="custom-form">
          ...
          <Form.Group controlId="formBasicDireccion">
            ...
            <Form.Control
              ...
              className={
                invalidFields.includes("direccion") ? "is-invalid" : ""
              }
            />
          </Form.Group>
          ...
          <Form.Group controlId="formBasicEmail">
            ...
            <Form.Control
              type="password"
              name="contrasenia"
              value={newFundacion.contrasenia}
              onChange={handleChange}
              placeholder="contrasenia"
              className={
                invalidFields.includes("contrasenia") ? "is-invalid" : ""
              }
            />
          </Form.Group>
          <Form.Group controlId="formBasicFundadaEn">
            ...
            <Form.Control
              ...
              onChange={handleChange}
              className={
                invalidFields.includes("fundadaEn") ? "is-invalid" : ""
              }
            />
          </Form.Group>
